# 홈페이지를 Python CGI로 구현하기

- index.html 대신 index.py로 동일한 웹사이트 구현이 가능
- 하단의 코드는 CGI로 사이트 구현시 Default로 수행
...
- py 파일로 접속 시 html과 동일한 사이트 확인 가능
